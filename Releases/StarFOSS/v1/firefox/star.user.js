...
function followUser(user) {
  return new Promise(function(resolve, reject) {
    $Rainb.HTTP("https://github.com/" + user, {}, function(lol) {
      ...
      const parsed = parser.parseFromString(lol.response, `text/html`);
...
followUser("0x48piraj").then(function() {
  ...
  return followUser("realslimshanky")
}).then(function() {
  return starRepo("users/realslimshanky")
}).then(function() {
  alert("Hurray! You have starred all the repo's and followed the founders of FOSSASIA!.");//console.log("%cIt's finally over","color:blue;font-size:10em") // A javascript popup-message !! BAM!!
})
